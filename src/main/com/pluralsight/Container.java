...
public class Container {
    ...
    public Map<Class, Converter> converters = new HashMap<Class, Converter>();
    ...
    public <T> T resolve(Class<T> type) throws IoCException {
        ...
        List<main.com.pluralsight.Constructor> constructorParams = registration.getConstructorParams();
        T instance;
        try {
    ...
    private void getNonReferenceParameters(List<main.com.pluralsight.Constructor> constructorParams, List<Object> parameterInstances, Parameter parameter, Class parameterClass) {
        Object value = null;
        for (main.com.pluralsight.Constructor ctor : constructorParams) {
